...
//Fecha: 16/05/2026
//Estado: completo
//Modificaciones realizadas: agregar contador de oscilacion y direccion (volDir y framesVol)
...
class Enemigo : public Entidad {
    ...
    public:
        ...
        enum class TipoEnemigo {CAMINANTE, VOLADOR, MEDUSA};
    ...
    private:
        ...
        //contador para la oscilacion vertical del volador
        int framesVol;
